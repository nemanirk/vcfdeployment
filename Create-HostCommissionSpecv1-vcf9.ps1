...
# UPDATED: Hardcoded username to 'root' and removed Read-Host prompt

# ==============================================================================================================================
# This script generates a Json Spec for Host comission which can be used with the Import JSON option in SDDC while comissioning the hosts
# ==============================================================================================================================
...
if ($isSequential -eq "yes") {
    ...
    for ($i = 0; $i -lt $hostCount; $i++) {
        # zero-padding suffix formatting
